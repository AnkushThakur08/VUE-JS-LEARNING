    ...
    <div>
      <div class="flex items-center space-x-3 mb-6">
        ...
        <span
          ...
          >{{ props.product.rating }} outof 5</span
        >
      </div>
      <a href="#">
      ...
      <div class="flex items-center justify-between mt-6">
        <span class="text-3xl font-extrabold text-heading">₹ {{  (props.product.price * 100).toFixed(2) }}</span>
        <button
          type="button"
          class="inline-flex items-center text-white bg-brand hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-3 py-2 focus:outline-none cursor-pointer"
        >
          <svg
